...
#ifndef KABBERRY_LEGACY_SPOS_H
#define KABBERRY_LEGACY_SPOS_H
...
class CLegacysKKCStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    explicit CLegacysKKCStake(const libzerocoin::CoinSpend& spend);
    bool IssKKC() const override { return true; }
