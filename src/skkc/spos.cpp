...
CLegacysKKCStake::CLegacysKKCStake(const libzerocoin::CoinSpend& spend)
{
...
CBlockIndex* CLegacysKKCStake::GetIndexFrom()
{
...
CAmount CLegacysKKCStake::GetValue() const
{
    return denom * COIN;
}

CDataStream CLegacysKKCStake::GetUniqueness() const
{
